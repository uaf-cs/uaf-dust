...
var PalliativeService = /** @class */ (function () {
    ...
    PalliativeService.prototype.updatePalliative = function (palliative) {
        var _this = this;
        return this.http.put(this.serviceUrl + ("/" + palliative.id), palliative, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (_) { return _this.log("updated palliative id=" + palliative.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('updatePalliative')));
    };
    ...
    PalliativeService.prototype.deletePalliative = function (palliative) {
        ...
        var url = this.serviceUrl + "/" + id;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (_) { return _this.log("deleted palliative id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('deletePalliative')));
    };
...
var SplashscreenService = /** @class */ (function () {
    function SplashscreenService() {
        this.disclaimerAccepted_ = false;
    }
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.updateUser = function (user) {
        ...
        var id = user.id;
        var url = this.serviceUrl + "/" + id;
        return this.http.put(url, user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("updated user id=" + user.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('updateUser')));
    };
...
module.exports = __webpack_require__(/*! C:\Users\jonat\AppData\Local\Packages\CanonicalGroupLimited.Ubuntu18.04onWindows_79rhkp1fndgsc\LocalState\rootfs\home\jonathan\node-projects\uafdust\dust-app\src\main.ts */"./src/main.ts");
